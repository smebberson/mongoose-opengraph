...
var defaults = function (options) {
	...
	options.ogDescriptionType = options.ogDescriptionType || String;
	...
	options.ogImageType = options.ogImageType || String;
	...
	options.ogVideoType = options.ogVideoType || String;
...
module.exports = function openGraphPlugin (schema, options) {
	...
	if (options.ogDescription === true) {
		schema.add({
			ogDescription: options.ogDescriptionType
		});
	}
